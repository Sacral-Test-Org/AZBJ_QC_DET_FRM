...
public class ControlDTO {
    ...
    // Fields for policy reference validation and processing
    private BeneficiaryDetailsDTO beneficiaryDetails;
    private String applicationNumber;
    private String appointeeGender;

    // Fields for QC Section Navigation and Record Update
    private String ci;
    private Integer flg;
    ...
    private String qcVerificationStatus;
    ...
    public String getQcVerificationStatus() {
        return qcVerificationStatus;
    }

    public void setQcVerificationStatus(String qcVerificationStatus) {
        this.qcVerificationStatus = qcVerificationStatus;
    }
}
